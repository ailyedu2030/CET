                    ...
                    <Grid.Col span={12}>
                      <Stack gap="xs">
                        ...
                        <Text size="xs" c="dimmed">
                          ...
                          <br />
                          ✓ 热点数据流动：双向流动（采集→教学→训练）
                          <br />
                          ✓ 数据追踪：全链路数据流转追踪
                          <br />✓ 数据权属：明确定义数据所有权和使用权
                        </Text>
                      </Stack>
                    </Grid.Col>
                  </Grid>
          ...
          <Tabs.Panel value="standardization">
            <Card withBorder>
              <Stack gap="md">
                ...
                <Text c="dimmed">教材标准、评分标准、API对接、数据导出的标准化实现</Text>
          ...
          <Tabs.Panel value="permission">
            <Card withBorder>
              <Stack gap="md">
                ...
                <Text c="dimmed">教师权限、管理员权限、权限申请、操作审计的完整实现</Text>
          ...
          <Tabs.Panel value="data-integration">
            <Card withBorder>
              <Stack gap="md">
                ...
                <Text c="dimmed">知识点库贯通、热点数据流动、数据追踪、数据权属的完整实现</Text>
