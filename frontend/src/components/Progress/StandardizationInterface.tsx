            ...
            integration_apis: [
              {
                ...
                status: 'active',
                version: 'v1.2',
                usage_count: systemStatus?.api_usage?.['analytics'] || 1250,
              },
              {
                name: 'Student Progress API',
                status: 'active',
                version: 'v1.1',
                usage_count: systemStatus?.api_usage?.['progress'] || 890,
              },
              {
                name: 'Content Management API',
                status: 'active',
                version: 'v1.0',
                usage_count: systemStatus?.api_usage?.['content'] || 567,
              },
            ],
          },
          data_standards: {
        ...
        <Card withBorder padding="md">
          ...
          <Tabs value={activeTab} onChange={value => setActiveTab(value || 'cet4')}>
            ...
            <Tabs.Panel value="cet4" pt="md">
              <Stack gap="md">
                <Alert icon={<IconCheck size={16} />} color="green" title="四级标准集成状态">
                  <Text size="sm">
                    ✅ 写作模块已深度整合四级考核标准，评分准确率达到{' '}
                    {standardData.cet4_standards.integration_status.scoring_accuracy}%
                  </Text>
                </Alert>
                ...
                <Grid>
                  <Grid.Col span={{ base: 12, md: 6 }}>
                    ...
                    <Stack gap="xs">
                      {standardData.cet4_standards.writing_standards.score_ranges.map(
                        (range, index) => (
                          <Card key={index} withBorder padding="xs">
                            <Group justify="space-between" mb="xs">
                              <Badge color="blue">{range.level}</Badge>
                              <Text size="xs">
                                {range.range[0]}-{range.range[1]}分
                              </Text>
                            </Group>
                  ...
                  <Grid.Col span={{ base: 12, md: 6 }}>
                    ...
                    <Stack gap="xs">
                      <Group justify="space-between">
                        ...
                        <Badge>
                          {
                            standardData.cet4_standards.writing_standards.vocabulary_requirements
                              .total_words
                          }
                        </Badge>
                      </Group>
                      ...
                      {Object.entries(
                        ...
                        <Group key={level} justify="space-between">
                          <Text size="xs" c="dimmed">
                            {level === 'high' ? '高频' : level === 'medium' ? '中频' : '低频'}词汇
                          </Text>
            ...
            <Tabs.Panel value="teaching" pt="md">
              <Stack gap="md">
                <Group justify="space-between">
                  ...
                  <Badge color="blue">
                    {standardData.teaching_compatibility.data_format_compatibility}%
                  </Badge>
                </Group>
                <Progress
                  value={standardData.teaching_compatibility.data_format_compatibility}
                  color="blue"
                />
            ...
            <Tabs.Panel value="api" pt="md">
              <Stack gap="md">
                ...
                <Table>
                  ...
                  <Table.Tbody>
                    {standardData.api_standards.third_party_integrations.map(
                      (integration, index) => (
                        <Table.Tr key={index}>
        ...
        {selectedStandard && (
          <Stack gap="md">
            <Group>
              ...
              <Text size="sm">
                分数范围: {selectedStandard.range[0]}-{selectedStandard.range[1]}
              </Text>
            </Group>
