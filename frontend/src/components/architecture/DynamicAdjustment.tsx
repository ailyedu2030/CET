...
const DynamicAdjustment: React.FC = () => {
  ...
  const [evolutionModalOpened, { open: openEvolutionModal, close: closeEvolutionModal }] =
    useDisclosure(false)
  ...
  return (
    <Stack gap="md">
      <Group justify="space-between">
        ...
        <Group>
          <Button leftSection={<IconEdit size={16} />} onClick={openEvolutionModal}>
            教案演进
          </Button>
          <Button leftSection={<IconQuestionMark size={16} />} onClick={openQuestionModal}>
            生成题目
          </Button>
          <Button
      ...
      >
        <Stack gap="md">
          ...
          <Group justify="flex-end">
            ...
            <Button onClick={handleEvolveLessonPlan} loading={evolveLessonPlanMutation.isPending}>
              开始演进
            </Button>
          </Group>
        </Stack>
      ...
      >
        <Stack gap="md">
          ...
          <Group justify="flex-end">
            ...
            <Button onClick={handleGenerateQuestions} loading={generateQuestionsMutation.isPending}>
              生成题目
            </Button>
          </Group>
        </Stack>
