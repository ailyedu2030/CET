...
from .ai_schemas import (AITaskRequest, AITaskResponse, CollaborationJoinRequest,
                         CollaborationSessionResponse, CollaborationUpdateRequest,
                         LearningAnalysisCreate, LearningAnalysisListResponse,
                         LearningAnalysisRequest, LearningAnalysisResponse,
                         LessonPlanCreate, LessonPlanGenerationRequest,
                         LessonPlanListResponse, LessonPlanResponse, LessonPlanUpdate,
                         LessonScheduleCreate, LessonScheduleResponse,
                         LessonScheduleUpdate, ScheduleGenerationRequest,
                         ScheduleListResponse, SmartSuggestionRequest,
                         SmartSuggestionResponse, SyllabusCreate,
                         SyllabusGenerationRequest, SyllabusListResponse,
                         SyllabusResponse, SyllabusUpdate, TeachingAdjustmentCreate,
